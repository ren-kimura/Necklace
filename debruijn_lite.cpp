...
using namespace std;
using EcAdjList = unordered_map<string, vector<string>>;
using NcAdjList = vector<vector<int>>;
using Path = pair<deque<pair<int, int>>, uint8_t>;
using Paths = pair<vector<pair<deque<pair<int, int>>, uint8_t>>, int>;
